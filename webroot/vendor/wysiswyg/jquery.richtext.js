(function ( $ ) {
    ...
    $.fn.richText = function( options ) {
        ...
        var $dropdownList = $('<ul />', {class: "richText-dropdown"}), // dropdown lists
            ...
            $formButton = $('<button />', {text: "Guardar", class: "btn"}); // button
        ...
        $titles.append($('<li />', {html: '<a data-command="formatBlock" data-option="h3">Título</a>'}));
        $titles.append($('<li />', {html: '<a data-command="formatBlock" data-option="h4">Subtítulo</a>'}));
        $titles.append($('<li />', {html: '<a data-command="formatBlock" data-option="p">Texto</a>'}));
        //$titles.append($('<li />', {html: '<a data-command="formatBlock" data-option="h4">Título #4</a>'}));
        ...
        if(settings.fileHTML 
            ...
            $fileForm.append(
                $formItem.clone()
                    .append($formLabel.clone().text("URL Archivo").attr("for", "fileURL"))
                    .append($formInput.clone().attr("id", "fileURL"))
                );
            $fileForm.append(
                $formItem.clone()
                    .append($formLabel.clone().text("Link Texto").attr("for", "fileText"))
