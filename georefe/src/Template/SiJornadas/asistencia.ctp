            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <ol class="breadcrumb pull-right">
                        ...
                        <li><?= $this->Html->link('Jornada', ['action' => 'index']) ?></li>
                        <li class="active">Asistencia a Jornada</li>
                    </ol>

                    <div class="card-content">

                        <h4>Asistencia a Jornada, <b> <?= $jornada->descripcion ?></b></h4>                        
                                ...
                                <tbody>
                                    <?php foreach ($siJornadaAsistentes as $siJornadaAsistente) { ?>
                                        <tr>
                                            ...
                                            //pr($siJornadaAsistencias->toArray());
                                            
                                            foreach ($siJornadaAsistencias as $siJornadaAsistencia) {
                                                if ($siJornadaAsistente->id == $siJornadaAsistencia->id_jornada_asistente) {
                                                    ?>
                                                    <td> 
                                                        <input id="<?= $siJornadaAsistencia->id ?>" type="checkbox" <?= ($siJornadaAsistencia->asistio) ? "checked" : "" ?> class="checkAsistencia" onchange="asistencia(<?= $siJornadaAsistencia->id ?>)" name="<?= $siJornadaAsistencia->id ?>">                                                                                                    
                                                    </td>
                                                    <?php
                                                }
                                            }
