            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <ol class="breadcrumb pull-right">
                        ...
                        <li><?= $this->Html->link('Lista Grupos de Liderazgo', ['action' => 'index']) ?></li>
                        <li class="active">Reporte Lideres Grupos de Liderazgo</li>
                    </ol>

                    <div class="card-content">

                        <h4>Reporte Lideres, Grupo Liderazgo <b> <?= $gl->id ?></b></h4>                        

                        <?= $this->Html->link(__('Exportar Informe'), ['action' => 'reporte4pdf', $gl->id, '_ext' => 'pdf'], ['class' => 'btn btn-primary']); ?>
