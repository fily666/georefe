            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <ol class="breadcrumb pull-right">
                        ...
                        <li class="active">Asistentes Punto de Encuentro</li>
                    </ol>

                    <div class="card-content">

                        <h4>Asistentes Punto de Encuentro, <b><?= $puntoEncuentro->descripcion ?></b></h4>                        
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9">
                                        <?=
                                        $this->Form->select('id_pastor', $lista3, ['id' => 'select3', 'class' => 'form-control',
                                ...
                                <tbody>
                                    <?php foreach ($siPuntosEncuAsistentes as $siPuntosEncuAsistente) { ?>
                                        <tr>
                                            ...
                                            <td><?= $siPuntosEncuAsistente->ma_propiedade->valor ?></td>
                                            <td><?= $siPuntosEncuAsistente->persona->telefono1 ?></td>
                                            <td><?= $siPuntosEncuAsistente->persona->celular ?></td>
                                            <td><?= $siPuntosEncuAsistente->guium->nombres . ' ' . $siPuntosEncuAsistente->guium->apellidos ?></td>
                                            <td><?= $siPuntosEncuAsistente->si_pastore->person->nombres . ' ' . $siPuntosEncuAsistente->si_pastore->person->apellidos ?></td>

                                            <td>
                                                <?php
                                                if ($siPuntosEncuAsistente->status_id == 1) {
                                                    echo '<span class="label label-success">' . $siPuntosEncuAsistente->ma_status->value . '</span>';
                                                } elseif ($siPuntosEncuAsistente->status_id == 2) {
                                                    echo '<span class="label label-danger">' . $siPuntosEncuAsistente->ma_status->value . '</span>';
                                                } elseif ($siPuntosEncuAsistente->status_id == 3) {
                                                    echo '<span class="label label-danger">' . $siPuntosEncuAsistente->ma_status->value . '</span>';
                                                } else {
                                            ...
                                            <td class="text-right">
                                                ...
                                                echo $this->Form->postLink(
                                                        $this->Html->image('/img/ico_delete.jpg', ['style' => 'width: 20px; height: auto; margin-left: 10px', "alt" => __('Eliminar'), "title" => __('Eliminar')]), ['action' => 'delete3', $siPuntosEncuAsistente->id, $puntoEncuentro->id], ['escape' => false, 'confirm' => __('¿Está seguro?')]
                                                );
                                                ?>
                                            </td>  
                                        </tr>
