            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header card-header-text" data-background-color="rose">
                        <h4 class="card-title">Agregar Punto de Encuentro</h4>    
                    </div>

                    <ol class="breadcrumb pull-right">
                        <li><?= $this->Html->link('Inicio', ['controller' => 'Home', 'action' => 'index']) ?></li>
                        <li><?= $this->Html->link('Puntos de Encuentro', ['action' => 'index']) ?> 
                        </li>
                        <li class="active">Agregar Punto de Encuentro</li>
                    </ol>
                    ...
                    <div class="card-content">                        
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <?= $this->Form->create($siPuntoEncuentro, ['role' => 'form', 'class' => 'form-horizontal', 'id' => 'formAddPE']) ?>
