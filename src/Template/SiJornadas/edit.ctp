            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header card-header-text" data-background-color="rose">
                        <h4 class="card-title">Editar Jornada</h4>    
                    </div>
                    ...
                    <ol class="breadcrumb pull-right">
                        ...
                        <li class="active">Editar Jornada</li>
                    </ol>
                    ...
                    <div class="card-content">                        
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <?= $this->Form->create($siJornada, ['role' => 'form', 'class' => 'form-horizontal', 'id' => 'formEditPE']) ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            ...
                                            $this->Form->input('fecha_inicio', [
                                                ...
                                                'value' => ($siJornada != '' && $siJornada->fecha_inicio != '') ? date_format($siJornada->fecha_inicio, 'Y-m-d') : '',
                                                'type' => 'text',
                                                'id' => 'fecha_inicio',
                                                'label' => false
                                            ])
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            ...
                                            $this->Form->input('fecha_fin', [
                                                'class' => 'form-control form_date',
                                                'data-date-format' => 'yyyy-mm-dd',
                                                'value' => ($siJornada != '' && $siJornada->fecha_fin != '') ? date_format($siJornada->fecha_fin, 'Y-m-d') : '',
                                                'type' => 'text',
                                                'id' => 'fecha_fin',
                                                'label' => false
                                            ])
