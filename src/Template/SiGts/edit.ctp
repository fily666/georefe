            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header card-header-text" data-background-color="rose">
                        <h4 class="card-title">Editar Grupos de Transformaci&oacute;n</h4>    
                    </div>
                    ...
                    <ol class="breadcrumb pull-right">
                        ...
                        <li class="active">Editar Grupos de Transformaci&oacute;n</li>
                    </ol>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            ...
                                            $this->Form->input('fecha_inicia', [
                                                ...
                                                'type' => 'text',
                                                'value' => ($siGt->fecha_inicia != null ) ? date_format($siGt->fecha_inicia, 'Y-m-d') : '',
                                                'id' => 'fecha_inicio',
                                                'label' => false
                                            ])
                                            ?>   
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            ...
                                            $this->Form->input('hora_reunion', [
                                                ...
                                                'type' => 'text',
                                                'value' => date_format($siGt->hora_reunion, 'H:m') ,
                                                'id' => 'hora_reunion',
                                                'label' => false
                                            ])
                                            ?>   
