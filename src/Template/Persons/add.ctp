                    ...
                    <div class="card-content">                        
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <?= $this->Form->create($person, ['role' => 'form', 'class' => 'form-horizontal', 'enctype' => 'multipart/form-data', 'id' => 'formAddPerson']) ?>
                                ...
                                <div class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <?= $this->Form->input('nombres', ['class' => 'form-control', 'label' => false]) ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <?= $this->Form->input('apellidos', ['class' => 'form-control', 'label' => false]) ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <?= $this->Form->select('id_barrio', $barrios, ['id' => 'barrios', 'class' => 'form-control', 'empty' => ':: Seleccione ::',
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="fileinput fileinput-new text-center col-lg-4" data-provides="fileinput">
                                            <div class="fileinput-new thumbnail">
                                                <?= $this->Html->image('/attachments/users/default.png', ['alt' => 'Avatar', 'style' => 'width: auto; height: 150px']); ?>
                                            </div>
