            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header card-header-text" data-background-color="rose">
                        <h4 class="card-title">Editar Verificaci&oacute;n</h4>    
                    </div>
                    ...
                    <ol class="breadcrumb pull-right">
                        ...
                        <li class="active">Editar Verificaci&oacute;n</li>
                    </ol>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            ...
                                            $this->Form->input('fecha_entrega', [
                                                ...
                                                'type' => 'text',
                                                'value' => ($verificacion != '' && $verificacion->fecha_entrega != '') ? date_format($verificacion->fecha_entrega, 'Y-m-d') : '',
                                                'id' => 'fecha_nacimiento',
                                                'label' => false
                                            ])
                                            ?>   
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            ...
                                            $this->Form->input('fecha_hora_llamada', [
                                                ...
                                                'value' => ($verificacion != '' && $verificacion->fecha_hora_llamada != '') ? date_format($verificacion->fecha_hora_llamada, 'Y-m-d H:i') : '',
                                                'type' => 'text',
                                                'id' => 'fecha_nacimiento',
                                                'label' => false
                                            ])
