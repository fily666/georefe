            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <ol class="breadcrumb pull-right">
                        ...
                        <li><?= $this->Html->link('Exodos', ['action' => 'index']) ?></li>
                        <li><?= $this->Html->link('Asociación de Tema', ['action' => 'index2', $exodo->id]) ?></li>
                    ...
                    <div class="card-content">                        
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <?= $this->Form->create($siExodoTema, ['role' => 'form', 'class' => 'form-horizontal', 'id' => 'formEdit']) ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            ...
                                            $this->Form->input('fecha', [
                                                ...
                                                'type' => 'text',
                                                'value' => ($siExodoTema != '' && $siExodoTema->fecha != '') ? date_format($siExodoTema->fecha, 'Y-m-d') : '',
                                                'id' => 'fecha',
                                                'label' => false,
                                                'required' => true
                                            ])
                                ...
                                <div class="form-group">
                                    <div class="col-lg-offset-2 col-lg-10">
                                        <?= $this->Html->link('Cancelar', ['action' => 'index2', $exodo->id], ['class' => 'btn btn-primary']); ?>
