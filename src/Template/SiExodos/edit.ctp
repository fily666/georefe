            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header card-header-text" data-background-color="rose">
                        <h4 class="card-title">Editar &Eacute;xodo</h4>    
                    </div>
                    ...
                    <ol class="breadcrumb pull-right">
                        ...
                        <li class="active">Editar &Eacute;xodo</li>
                    </ol>
                    ...
                    <div class="card-content">                        
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <?= $this->Form->create($siExodo, ['role' => 'form', 'class' => 'form-horizontal', 'id' => 'formEditPE']) ?>
                                ...
                                <div class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            ...
                                            $this->Form->input('fecha_inicio', [
                                                ...
                                                'value' => ($siExodo != '' && $siExodo->fecha_inicio != '') ? date_format($siExodo->fecha_inicio, 'Y-m-d') : '',
                                                'type' => 'text',
                                                'id' => 'fecha_inicio',
                                                'label' => false
                                            ])
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            ...
                                            $this->Form->input('fecha_fin', [
                                                'class' => 'form-control form_date',
                                                'data-date-format' => 'yyyy-mm-dd',
                                                'value' => ($siExodo != '' && $siExodo->fecha_fin != '') ? date_format($siExodo->fecha_fin, 'Y-m-d') : '',
                                                'type' => 'text',
                                                'id' => 'fecha_fin',
                                                'label' => false
                                            ])
                                    ...
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">Tipo de &eacute;xodo</label>
                                        <div class="col-lg-9">
                                            <?= $this->Form->select('id_tipo_exodo', $lista2, ['id' => 'id_tipo_exodo', 'class' => 'form-control', 'empty' => ':: Seleccione ::', 'label' => false]) ?>
                                        </div>
                                    </div> 
