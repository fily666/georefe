            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <ol class="breadcrumb pull-right">
                        ...
                        <li class="active">Asistentes Grupo Liderazgo</li>
                    </ol>

                    <div class="card-content">

                        <h4>Asistentes Grupo Liderazgo, <b><?= $gl->id ?></b></h4>                        
                                ...
                                <tbody>
                                    <?php foreach ($siGlAsistentes as $siGlAsistente) { ?>
                                        <tr>
                                            ...
                                            <td><?= $siGlAsistente->ma_propiedade->valor ?></td>
                                            <td><?= $siGlAsistente->persona->telefono1 ?></td>
                                            <td><?= $siGlAsistente->persona->celular ?></td>                                           

                                            <td>
                                                <?php
                                                if ($siGlAsistente->status_id == 1) {
                                                    echo '<span class="label label-success">' . $siGlAsistente->ma_status->value . '</span>';
                                                } elseif ($siGlAsistente->status_id == 2) {
                                                    echo '<span class="label label-danger">' . $siGlAsistente->ma_status->value . '</span>';
                                                } elseif ($siGlAsistente->status_id == 3) {
                                                    echo '<span class="label label-danger">' . $siGlAsistente->ma_status->value . '</span>';
                                                } else {
                                            ...
                                            <td class="text-right">
                                                ...
                                                echo $this->Form->postLink(
                                                        $this->Html->image('/img/ico_delete.jpg', ['style' => 'width: 20px; height: auto; margin-left: 10px', "alt" => __('Eliminar'), "title" => __('Eliminar')]), ['action' => 'delete3', $siGlAsistente->id, $gl->id], ['escape' => false, 'confirm' => __('¿Está seguro?')]
                                                );
                                                ?>
                                            </td>  
                                        </tr>
